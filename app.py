...
if selected == "Readme":
    ...
    st.write("Total Number of Maximal Cliques: 226859")
    st.image("images/WhatsApp Image 2025-03-22 at 00.42.22_7d8f6a4d.jpg", caption="Dataset-1", use_container_width=True)
    st.image("images/WhatsApp Image 2025-03-22 at 00.42.22_72b139bc.jpg", caption="Dataset-2", use_container_width=True)
    st.image("images/WhatsApp Image 2025-03-22 at 00.42.22_784f31ee.jpg", caption="Dataset-3", use_container_width= True)
