...
if selected == "Readme":
    ...
    st.write("Total Number of Maximal Cliques: 226859")
    st.image("clique_size_histogram.png", caption="Dataset-1", use_container_width=True)
    st.image("output2_histogram", caption="Dataset-2", use_container_width=True)
    st.image("output3_histogram", caption="Dataset-3", use_container_width= True)
