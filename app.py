...
if selected == "Readme":
    ...
    st.image("images/Email-enron_dataset.png", caption="Dataset-1", use_container_width=True)
    ...
    st.image("images/as-Skitter_dataset.png", caption="Dataset-2", use_container_width=True)
    ...
    st.image("images/Wiki-vote_dataset.png", caption="Dataset-3", use_container_width=True)
